...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let calculator_agent = providers::ollama::Client::from_url(LLM_BASE_URL)
        .agent(LLM_MODEL)
        .preamble(
...
// summarize what this code does and how it works in general terms without referring to specific values:
